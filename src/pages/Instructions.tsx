  ...
  return (
    <>
      ...
      <p className="article-card p-4">
        <i className="ri-camera-line ri-lg mr-1" aria-hidden="true"></i>{'\u2192 '}{t('instructions_flow_1')}{' '}
        <i className="ri-camera-lens-line ri-lg mr-1" aria-hidden="true"></i>{'\u2192 '}{t('instructions_flow_2')}{' '}
        <i className="ri-eraser-line ri-lg mr-1" aria-hidden="true"></i>{'\u2192 '}{t('instructions_flow_3')}{' '}
        <i className="ri-download-2-line ri-lg mr-1" aria-hidden="true"></i>{'\u2192 '}{t('instructions_flow_4')}
      </p>
      <h2 className="article-section-title">
        <i
      ...
      <p className="article-card p-3">
        <i className="ri-pencil-line ri-lg mr-1 icon-accent" aria-hidden="true"></i>
        {t('instructions_tip_pen')}
      </p>
      <p className="article-card p-3">
        <i className="ri-sun-line ri-lg mr-1 icon-accent" aria-hidden="true"></i>
        {t('instructions_tip_light')}
      </p>
      <p className="article-card p-3">
        <i className="ri-focus-3-line ri-lg mr-1 icon-accent" aria-hidden="true"></i>
        {t('instructions_tip_hold')}
      </p>
      <p className="article-card p-3">
        <i className="ri-smartphone-line ri-lg mr-1 icon-accent" aria-hidden="true"></i>
        {t('instructions_tip_back_cam')}
      </p>
      <p className="article-card p-3 sm:col-span-2">
        <i className="ri-landscape-line ri-lg mr-1 icon-accent" aria-hidden="true"></i>
        {t('instructions_tip_landscape')}
      </p>
      <p className="article-card p-3 sm:col-span-2">
        <i className="ri-code-s-slash-line ri-lg mr-1 icon-accent" aria-hidden="true"></i>
